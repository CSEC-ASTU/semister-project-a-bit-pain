<?php
    ...
    $date = date("md");
    $dateyear = date("y");
    $ID = "PID".$dateyear.$date.$previousid;


    if($post->upload_phone($ID, $data->brand, $data->name, $data->ram, $data->storage, $data->color, $data->screensize, $data->camerafront, $data->cameraback, $data->price, $data->description, $data->types, "false")){
