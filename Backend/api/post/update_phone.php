<?php
    ...
    if($post->update_phone($data->ID, $data->brand, $data->name, $data->ram, $data->storage, $data->color, $data->screensize, $data->camerafront, $data->cameraback, $data->price, $data->description, $data->types)){
