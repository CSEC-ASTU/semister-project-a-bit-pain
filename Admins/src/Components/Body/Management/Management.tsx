...
const Management = () => {
  ...
  return (
    <div>
        <div className='mx-16 md:mx-96 mt-4 h-4'>
            <ul className='flex flex-row justify-between'>
                {
                    components.map((items) => (
                        <li key={items.name} className={`${currentname === items.name? "border-b-2 border-gray-700 rounded-sm" : "border-0"} hover:border-b-2`}>
